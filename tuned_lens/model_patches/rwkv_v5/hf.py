...
from tuned_lens.model_patches.rwkv_v5.config import Rwkv5Config
...
def load_hf_rwkv5(model_name,device):
    ##TODO: model path should define the config
    if model_name == "RWKV/rwkv-5-world-1b5":
        model_path = "rwkv5_1b5.pth"
    elif model_name == "RWKV/rwkv-5-world-3b":
        model_path = "rwkv5_3b.pth"
    else:
        pass
